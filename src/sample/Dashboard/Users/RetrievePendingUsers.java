...
public class RetrievePendingUsers {
    ...
    private static final String USER_INFO = "SELECT * FROM user_account WHERE verification = 'NOT VERIFIED'";
    ...
    public void retrievePendVerificationUsers(ObservableList<UserAccountDataClass> data){
