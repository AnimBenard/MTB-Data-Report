...
public class DashboardController implements Initializable {
    @FXML
    AnchorPane ach_analytics, ach_users, ach_paneLoader, ach_hub, ach_spokes, ach_results, ach_reports, ach_store, ach_settings;
    @FXML
    ...
    public void openUserScene(MouseEvent event){
        ...
        if(lb_name.getText() == null || lb_name.getText().isEmpty()){
            ...
            try{
                ...
                Parent limbobo_root = loader.load();
                UsersController controller = loader.getController();
                controller.setUserLabels(lb_name.getText(), lb_userNo.getText());
                ach_paneLoader.getChildren().setAll(limbobo_root);
