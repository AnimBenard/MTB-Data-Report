package sample.Dashboard.Spokes.FullTableSpokes;
...
public class RetrieveSpokesRequestListDataByDate {
    ...
    private static final String FETCH_LIST = "SELECT * FROM request_list WHERE request_date BETWEEN ? AND ? AND request_type = 'SPOKES' ORDER BY Id DESC";
