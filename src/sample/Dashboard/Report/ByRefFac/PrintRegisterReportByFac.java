package sample.Dashboard.Report.ByRefFac;
...
public class PrintRegisterReportByFac {
    ...
    private static final String RESULTS_QUERY = "SELECT sample_id, surname, othernames, CONCAT(age, ' ', age_units) AS age, sex, referring_facility, address, type_of_specimen, sample_appearance, reason_for_examination, request_date FROM request_list WHERE MONTH(request_date) = ? AND YEAR(request_date) = ? AND referring_facility = ?";

    Connection conn = null;
    PreparedStatement preparedStatement = null;
    ResultSet resultSet = null;

    public void printReportForm(String year,String month, String reqType, String datePrinted) {
        //margin
        ...
        addHeaderAndFooter(doc, PdfPageSize.A4, margin, year, month, reqType, datePrinted);
        ...
        addDataToTable(page, year, month, reqType);
        //draw watermarks
    ...
    public void savePDFReportForm(String year, String month, String refFac, String datePrinted, String filePath) {
        //margin
        PdfDocument doc = new PdfDocument();
        PdfUnitConvertor unitCvtr = new PdfUnitConvertor();
        PdfMargins margin = new PdfMargins();
        ...
        margin.setRight(margin.getLeft());
        addHeaderAndFooter(doc, PdfPageSize.A3, margin, year, month, refFac, datePrinted);
        PdfPageBase page = doc.getPages().add(PdfPageSize.A4, margin, PdfPageRotateAngle.Rotate_Angle_0, PdfPageOrientation.Landscape);
        addDataToTable(page, year, month, refFac);
    ...
    public void addHeaderAndFooter(PdfDocument doc, Dimension2D pageSize, PdfMargins margin, String year, String month, String refFac, String datePrinted) {
        ...
        String methodName = "Monthly Register";
        String wardName = "By Referring Facility";
        String dateRange = "Month: "+month+" / "+year+"";
    ...
    public void addDataToTable(PdfPageBase page, String year, String month, String refFac) {
        ...
        try {
            ...
            try {
                ...
                preparedStatement.setString(3, refFac);
        ...
        table.getColumns().get(7).setColumnName("Specimen");
        table.getColumns().get(8).setColumnName("Specimen App");
        table.getColumns().get(9).setColumnName("Investigation");
        table.getColumns().get(10).setColumnName("Req Date");
