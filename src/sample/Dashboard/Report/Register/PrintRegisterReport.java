package sample.Dashboard.Report.Register;
...
public class PrintRegisterReport {
    ...
    private static final String RESULTS_QUERY = "SELECT sample_id, surname, othernames, CONCAT(age, ' ', age_units) AS age, sex, referring_facility, address, type_of_specimen, sample_appearance, reason_for_examination, request_date FROM request_list WHERE MONTH(request_date) = ? AND YEAR(request_date) = ? AND request_type = ?";
    ...
    public void savePDFReportForm(String year, String month, String reqType, String datePrinted, String filePath) {
        //margin
        PdfDocument doc = new PdfDocument();
        PdfUnitConvertor unitCvtr = new PdfUnitConvertor();
        PdfMargins margin = new PdfMargins();
        ...
        margin.setRight(margin.getLeft());
        addHeaderAndFooter(doc, PdfPageSize.A3, margin, year, month, reqType, datePrinted);
        PdfPageBase page = doc.getPages().add(PdfPageSize.A4, margin, PdfPageRotateAngle.Rotate_Angle_0, PdfPageOrientation.Landscape);
        addDataToTable(page, year, month, reqType);
    ...
    public void addHeaderAndFooter(PdfDocument doc, Dimension2D pageSize, PdfMargins margin, String year, String month, String reqType, String datePrinted) {
    ...
    public void addDataToTable(PdfPageBase page, String year, String month, String reqType) {
        ...
        try {
            ...
            try {
                ...
                preparedStatement.setString(3, reqType);
