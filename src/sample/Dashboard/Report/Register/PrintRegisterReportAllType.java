...
public class PrintRegisterReportAllType {
    ...
    private static final String RESULTS_QUERY = "SELECT sample_id, surname, othernames, CONCAT(age, ' ', age_units) AS age, sex, referring_facility, address, type_of_specimen, sample_appearance, reason_for_examination, request_date FROM request_list WHERE MONTH(request_date) = ? AND YEAR(request_date) = ?";
