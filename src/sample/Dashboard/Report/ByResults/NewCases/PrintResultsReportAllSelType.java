package sample.Dashboard.Report.ByResults.NewCases;
...
public class PrintResultsReportAllSelType {
    ...
    private static final String RESULTS_QUERY = "SELECT sample_id, surname, othernames, CONCAT(age, ' ', age_units) AS age, sex, referring_facility, address, reason_for_examination, results, request_date FROM request_list " +
            "WHERE reason_for_examination = 'TB Diagnosis' AND request_type = ?  AND request_date BETWEEN ? AND ?";
    ...
    public void addHeaderAndFooter(PdfDocument doc, Dimension2D pageSize, PdfMargins margin, String result, String reqType, String from, String to, String datePrinted) {
        ...
        String wardName = reqType + " (Result = Neg & Pos)";
    ...
    public void addDataToTable(PdfPageBase page, String result, String reqType, String from, String to) {
        ...
        try {
            ...
            try {
                ...
                preparedStatement.setString(1, reqType);
