...
public class PrintResultsReportFollowUpNegAll {
    ...
    private static final String RESULTS_QUERY = "SELECT sample_id, surname, othernames, CONCAT(age, ' ', age_units) AS age, sex, referring_facility, address, reason_for_examination, results, request_date FROM request_list WHERE reason_for_examination = 'Follow Up' AND request_date BETWEEN ? AND ? AND results = 'Neg'";
