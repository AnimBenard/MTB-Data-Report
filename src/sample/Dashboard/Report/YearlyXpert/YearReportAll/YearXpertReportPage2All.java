...
public class YearXpertReportPage2All {
    ...
    private static final String RESULTS_QUERY = "SELECT  " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_jul " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Total Test Performed' AS indicator, " +
            "    COUNT(CASE WHEN sex = 'M' THEN 1 END) AS male_count_aug, " +
            "    COUNT(CASE WHEN sex = 'F' THEN 1 END) AS female_count_aug " +
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Total Test Performed New Patient' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Total Test Performed for Preiously Treated Patients (Failures, relapse return after default)' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'MTB Not Detected (Negative)' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'MTB Detected Rifampicin Resistance not Detected' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'MTB Detected Rifampicin Resistance Detected' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'MTB Detected Rifampicin Resistance Indeterminate' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Errors' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Invalid results' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_dec " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '07' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_jul " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'No of RIF Resistance referred for culture and DST' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '08' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_aug " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '09' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_sep " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '10' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_oct " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '11' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_nov " +
            ...
            " " +
            "FROM request_list WHERE MONTH(examined_date) = '12' AND YEAR(examined_date) = ? AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_dec " +
