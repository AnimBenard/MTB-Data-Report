...
public class PrintYearlyGeneExpertReportSpokes {
    ...
    private static final String RESULTS_QUERY = "SELECT  " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Total Test Performed' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS ttp_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Total Test Performed New Patient' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS ttpnp_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Total Test Performed for Preiously Treated Patients (Failures, relapse return after default)' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'Drug Resistant') AS ttpfptp_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'MTB Not Detected (Negative)' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination = 'TB Diagnosis') AS mtbnd_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'MTB Detected Rifampicin Resistance not Detected' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifnd_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'MTB Detected Rifampicin Resistance Detected' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifd_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'MTB Detected Rifampicin Resistance Indeterminate' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS mtbdrifi_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Errors' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS err_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'Invalid results' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS irr_jun " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '01' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_jan " +
            " " +
            "LEFT JOIN " +
            " " +
            "(SELECT  'No of RIF Resistance referred for culture and DST' AS indicator, " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '02' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_feb " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '03' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_mar " +
            " " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '04' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_apr " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '05' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_may " +
            ...
            "FROM request_list WHERE MONTH(examined_date) = '06' AND YEAR(examined_date) = ? AND request_type = 'SPOKES' AND results IS NOT NULL AND reason_for_examination IN ('TB Diagnosis', 'Drug Resistant')) AS nrrfc_jun " +
    ...
    YearXpertReportPage2Spokes yearXpertReportPage2Spokes = new YearXpertReportPage2Spokes();
    YearCartridgeReportSpokes yearCartridgeReportSpokes = new YearCartridgeReportSpokes();
    ...
    public void printReportForm(String ward, String year,String month, String datePrinted) {
        ...
        yearXpertReportPage2Spokes.addDataToTable(page2, "", year, "");
        //draw watermarks
    ...
    public void savePDFReportForm(String ward, String year, String month, String datePrinted, String filePath) {
        ...
        addDataToTable(page, ward, year, month);
        yearXpertReportPage2Spokes.addDataToTable(page2, "", year, "");
        yearCartridgeReportSpokes.addDataToTable(page3, "", year, "");
