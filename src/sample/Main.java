...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        Parent limbobo_root = FXMLLoader.load(getClass().getResource("sample.fxml"));
        Scene scene = new Scene(limbobo_root, 600, 145, Color.TRANSPARENT);
        limbobo_root.setStyle("-fx-background-color: transparent");
        ...
        pauseTransition.setOnFinished(e -> {
            FadeTransition fadeTransition = new FadeTransition(Duration.seconds(3), limbobo_root);
